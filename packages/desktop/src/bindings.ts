...
export const commands = {
	...
	getServerPort: () => __TAURI_INVOKE<number | null>("get_server_port"),
	setServerPort: (port: number | null) => __TAURI_INVOKE<null>("set_server_port", { port }),
	getServerPassword: () => __TAURI_INVOKE<string | null>("get_server_password"),
	...
	setServerExternalHostname: (hostname: string | null) => __TAURI_INVOKE<null>("set_server_external_hostname", { hostname }),
